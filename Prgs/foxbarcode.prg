...
*  cImageType = "JPG"  && Image type ["JPG", "GIF", "PNG", "BMP", "TIF"]
  cImageType = "BMP"  && Image type ["JPG", "GIF", "PNG", "BMP", "TIF"]
  ...
  *-- Human-readable text
  ...
  cHumanReadableTextWayra = "" && Human-readable text Wayra to display
        ...
        DO CASE
          ...
          OTHERWISE  && The rest of the bar code
            ...
            *THIS.oGra.DrawString(THIS.cHumanReadableText, THIS.cFontName, THIS.nFontHeight, THIS.cFontStyle)
            && CCP
            THIS.oGra.DrawString(THIS.cHumanReadableTextWayra, THIS.cFontName, THIS.nFontHeight, THIS.cFontStyle)
            &&
        ENDCASE
      ENDIF
